...
//线条颜色
#define kBLueColor [UIColor colorWithRed:62/255.0 green:157/255.0 blue:254/255.0 alpha:1]
#define kLightBLueColor [UIColor colorWithRed:87/255.0 green:188/255.0 blue:253/255.0 alpha:1]
#define kRedColor [UIColor colorWithRed:228/255.0 green:35/255.0 blue:6/255.0 alpha:0.8]
...
- (void)addLeftLineLayer {
    ...
    _leftLineLayer.strokeColor = kBLueColor.CGColor;
...
- (void)addLeftCircle {
    ...
    _leftCircle.strokeColor = kLightBLueColor.CGColor;
...
- (void)addRightLineLayer {
    ...
    _rightLineLayer.strokeColor = kBLueColor.CGColor;
...
- (void)addRightCircle {
    ...
    _rightCircle.strokeColor = kLightBLueColor.CGColor;
...
- (void)addCenterTriangleLayer {
    ...
    layer1.strokeColor = kRedColor.CGColor;
    ...
    layer2.strokeColor = kRedColor.CGColor;
